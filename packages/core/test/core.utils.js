...
describe('Utils', function () {
    describe('.mergeProp()', function () {
        ...
        it('Merges the contents of arrays', function () {
            expect(utils.mergeProp(['one', 'two'], ['one', 'three', 'four'])).to.include.members([
                'one',
                'two',
                'three',
                'four',
        ...
        it('Applies default values from upstream objects', function () {
            expect(utils.mergeProp({ one: 'one', two: 'two' }, { one: 'eins', three: 'drei' })).to.eql({
                one: 'one',
                two: 'two',
                three: 'drei',
            });
            ...
            ).to.eql({ one: 'one', two: 'zwei', nested: { three: 'three', four: 'vier' } });
        });
