...
var SplitFrame = require('./components/split-frame');
var Tree = require('./components/tree');

fastclick(document.body);

var MainFrame = new SplitFrame($('#main-frame'));
...
},{"./components/split-frame":2,"./components/tree":3,"es6-promise":5,"fastclick":6,"jquery":8,"jquery-pjax":7}],2:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = function (element) {
    ...
    var el = $(element);
    var id = element[0].id;
    var panels = el.children('.Frame-panel');
    var gutter = el.children('.Frame-gutter').eq(0);
    var gutterSize = 10;
    ...
    var left = panels.eq(0);
    var right = panels.eq(1);
    ...
    var move = function move(e) {
        var leftPercentageWidth = (startPos + (e.pageX - start)) / docWidth * 100;
        ...
        var rightPercentageWidth = 100 - leftPercentageWidth;
