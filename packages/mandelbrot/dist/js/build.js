...
var mainFrame = frame($('#main-frame'));
...
},{"./components/frame":2,"./components/tree":3,"./events":4,"fastclick":7,"jquery":9,"jquery-pjax":8}],2:[function(require,module,exports){
(function (global){
'use strict';
...
module.exports = function (element) {
    ...
    var el = $(element);
    var id = element[0].id;
    var sidebar = el.children('[data-role="sidebar"]').first();
    var main = el.children('[data-role="main"]').first();
    var gutter = el.children('[data-role="gutter"]').first();
    ...
    var sidebarState = storage.get('frame.' + id + '.state', 'open');
    var sidebarWidth = storage.get('frame.' + id + '.sidebar', defWidth);
    var start = null;
    var lastStart = null;
    var docWidth = null;
    var collapsed = false;
    ...
    events.on('toggle-sidebar', function (e) {
...
},{"../events":4,"../storage":5,"../utils":6}],3:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../storage":5}],4:[function(require,module,exports){
(function (global){
'use strict';
