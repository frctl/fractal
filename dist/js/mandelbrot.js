...
var Browser = /*#__PURE__*/function () {
  ...
  _createClass(Browser, [{
    ...
    value: function _initFileSwitcher() {} // _initFileSwitcher() {
    ...
    value: function wrapRangeInMappedTextNode(dict, start, end, filterCb, eachCb) {
      ...
      dict.nodes.every(function (n, i) {
        ...
        if (typeof sibl === 'undefined' || sibl.start > start) {
          ...
          n.node = _this5.wrapRangeInTextNode(n.node, s, e); // recalculate positions to also find subsequent matches in the
    ...
    value: function search(list, key, collections) {
      ...
      items.each(function (_index, item) {
        ...
        if ($li.has('mark').length || $li.parents('.Tree-collection').has('mark').length || $li.parents('.Tree').find('.Tree-title').has('mark').length || tagAttributesMatch) {
          ...
          $li.removeAttr('hidden'); // recursive search inside nested collections
